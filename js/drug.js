initKG = function (data, config, container) {
    ...
    // console.log(nodes[20849])
    // console.log(nodeused[20849])
    console.log(JSON.stringify(nodes))
    document.querySelector('#nodeinfo').innerHTML = JSON.stringify(nodes);
    // nodes[1] = data.nodes[1]
    // console.log(Object.keys(data.nodes))
    // console.log(Object.keys(nodeused))
    ...
    var circle = svg.append("g")
        ...
        .on("click", function (node) {
            ...
            document.getElementById("ques_ans_input").value = lastFocusNode.name;
        }else if (idd==4){
        ...
        .on("mouseover",function(node){
            ...
            var content = "Name".bold().concat(": ",lastFocusNode.name,"; ", "Type: ".bold(),lastFocusNode.type,"; ", "Entity: ".bold(), lastFocusNode.Entity,"; ","Source: ".bold(), lastFocusNode.Source, "; ID: ".bold(),lastFocusNode.id1)
